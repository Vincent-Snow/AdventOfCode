...
let newGroupInput = groupInput.components(separatedBy: "\n\n")


var individualGroup: [[String]] = []
//var testArray = ["ygzdvpxjk","bzdgq","aulrhfwi"]
var groupAnswer = 0
var counter = 0

for i in newGroupInput {
    var group = i.components(separatedBy: "\n")
    individualGroup.append(group)
}
//print(individualGroup[0][0].count)
//print(individualGroup[0][0])
//individualGroup = [["x", "x"],["ygzdvpxjk","bzdgq","aulrhfwi"],["temsv","mavsdf","qwertymvui"],["a"]]
//print(individualGroup[0])
for x in individualGroup {
    iLoop: for i in x[0] {
        print(x)
        if x.count == 1 {
            counter+=x[0].count
...
//    print(i)
//    for j in 1...testArray.count-1 {
//        if testArray[0].contains(j) {
//
//        }
//    }
//}
...
for i in individualGroup {
    print(i[0].contains("x"))
}

print(individualGroup)
